...
# from .models import Pill, PillConsumption, GrandParent, CareTaker
from .models import *
    ...
    def post(self, request):
        ...
        if request.POST['button'] == "Login":
            ...
            if user is not None:
                ...
                return render(request={'HttpRequest'}, template_name={'../templates/index.html'}, context={'user': ""})
        # post request for Registering a new user
            ...
            account_sid = "ACd997fa65319fb4d0695f506cef1552e9"
            # Your Auth Token from twilio.com/console
            auth_token = "2adb7a9237da4d4bdba816f8e313860d"
